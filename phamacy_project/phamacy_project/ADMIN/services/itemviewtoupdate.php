...
<body>
    ...
    <div class="Main">
      ...
      <br>
        ...
        <input type="text" id="itemName" name="itemName" value="$itemName" placeholder="Item Name" required>

        <!-- <label for="address">Address:</label> -->
        <input type="text" id="company" name="company" value="<?php echo'$itemName'; ?> placeholder="Company Name" required>

        <!-- <label for="contactNo">Contact No:</label> -->
        <input type="text" id="price" name="price" value="<?php echo'$itemName'; ?>  placeholder="Item Price" required>

        <!-- <label for="password">Password:</label> -->
        <input type="text" id="discount" name="discount"value="<?php echo'$itemName';?> placeholder="Discount" required>

        <!-- <label for="password">Password:</label> -->
        <input type="text" id="discription" name="discription" value="<?php echo'$itemName'; ?> placeholder="Item Discription" required>

       <!-- <label for="password">Password:</label> -->
       <input type="file" id="image" name="image" value="<?php echo'$itemName'; ?> placeholder="Item Image" required>
...
if($result){
  while($row=mysqli_fetch_assoc($result)){
   ...
   <a href='delupd.php?updId=$itemId'>
